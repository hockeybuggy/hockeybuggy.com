...
type SiteSiteMetadataAuthor = {
  ...
  readonly preferredPronouns: Maybe<Scalars['String']>;
};
...
type SitePageContext = {
  ...
  readonly imagesSlug: Maybe<Scalars['String']>;
};
...
type MarkdownRemarkFrontmatter = {
  ...
  readonly edit_date: Maybe<Scalars['Date']>;
  readonly header_img: Maybe<Scalars['String']>;
  readonly order: Maybe<Scalars['Int']>;
  readonly github: Maybe<Scalars['String']>;
  readonly bannerImageName: Maybe<Scalars['String']>;
};
...
type MarkdownRemarkFrontmatter_edit_dateArgs = {
  formatString: Maybe<Scalars['String']>;
  fromNow: Maybe<Scalars['Boolean']>;
  difference: Maybe<Scalars['String']>;
  locale: Maybe<Scalars['String']>;
...
type MarkdownRemarkFrontmatterFilterInput = {
  ...
  readonly edit_date: Maybe<DateQueryOperatorInput>;
  ...
  readonly bannerImageName: Maybe<StringQueryOperatorInput>;
};
...
type FileFieldsEnum =
  ...
  | 'childrenMarkdownRemark.frontmatter.aliases'
  ...
  | 'childrenMarkdownRemark.frontmatter.edit_date'
  | 'childrenMarkdownRemark.frontmatter.header_img'
  | 'childrenMarkdownRemark.frontmatter.order'
  | 'childrenMarkdownRemark.frontmatter.github'
  | 'childrenMarkdownRemark.frontmatter.bannerImageName'
  ...
  | 'childMarkdownRemark.frontmatter.aliases'
  ...
  | 'childMarkdownRemark.frontmatter.edit_date'
  | 'childMarkdownRemark.frontmatter.header_img'
  | 'childMarkdownRemark.frontmatter.order'
  | 'childMarkdownRemark.frontmatter.github'
  | 'childMarkdownRemark.frontmatter.bannerImageName'
...
type SiteSiteMetadataAuthorFilterInput = {
  ...
  readonly preferredName: Maybe<StringQueryOperatorInput>;
  readonly preferredPronouns: Maybe<StringQueryOperatorInput>;
};
...
type SiteFieldsEnum =
  ...
  | 'siteMetadata.author.fullName'
  | 'siteMetadata.author.preferredName'
  | 'siteMetadata.author.preferredPronouns'
  | 'port'
  | 'host'
  | 'polyfill'
  | 'pathPrefix'
...
type SitePageContextFilterInput = {
  ...
  readonly imagesSlug: Maybe<StringQueryOperatorInput>;
};
...
type MarkdownRemarkFieldsEnum =
  ...
  | 'frontmatter.slug'
  | 'frontmatter.tags'
  | 'frontmatter.edit_date'
  | 'frontmatter.header_img'
  | 'frontmatter.order'
  | 'frontmatter.github'
  | 'frontmatter.bannerImageName'
  | 'excerpt'
  | 'rawMarkdownBody'
  | 'fileAbsolutePath'
  | 'fields.slug'
...
type BlogPostBySlugQuery = { readonly postBySlug: Maybe<(
...
type TagsQuery = { readonly allMarkdownRemark: (
    Pick<MarkdownRemarkConnection, 'totalCount'>
    & { readonly edges: ReadonlyArray<{ readonly node: { readonly frontmatter: Maybe<(
...
type CategoriesQuery = { readonly allMarkdownRemark: (
    Pick<MarkdownRemarkConnection, 'totalCount'>
    & { readonly edges: ReadonlyArray<{ readonly node: { readonly frontmatter: Maybe<(
          Pick<MarkdownRemarkFrontmatter, 'title' | 'slug'>
          & { year: MarkdownRemarkFrontmatter['date'], month: MarkdownRemarkFrontmatter['date'] }
...
type ProjectBySlugQuery = { readonly projectBySlug: Maybe<(
    Pick<MarkdownRemark, 'id' | 'excerpt' | 'html'>
    & { readonly frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'github' | 'bannerImageName'>> }
  )>, readonly projectImages: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<File, 'base' | 'relativeDirectory'>
        & { readonly childImageSharp: Maybe<{ readonly fluid: Maybe<Pick<ImageSharpFluid, 'aspectRatio' | 'base64' | 'src' | 'srcSet' | 'srcWebp' | 'srcSetWebp' | 'sizes'>> }> }
      ) }> } };
...
type IndexPageQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<(
    ...
    Pick<ImageSharp, 'id'>
    & { readonly fluid: Maybe<Pick<ImageSharpFluid, 'aspectRatio' | 'base64' | 'src' | 'srcSet' | 'srcWebp' | 'srcSetWebp' | 'sizes'>> }
  )> };

type CategoriesPageQueryVariables = Exact<{ [key: string]: never; }>;


type CategoriesPageQuery = { readonly allMarkdownRemark: { readonly group: ReadonlyArray<Pick<MarkdownRemarkGroupConnection, 'fieldValue' | 'totalCount'>> } };

type BlogIndexPageQueryVariables = Exact<{ [key: string]: never; }>;


type BlogIndexPageQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, readonly allBlogPosts: { readonly edges: ReadonlyArray<{ readonly node: { readonly frontmatter: Maybe<(
...
type TagsPageQuery = { readonly allMarkdownRemark: { readonly group: ReadonlyArray<Pick<MarkdownRemarkGroupConnection, 'fieldValue' | 'totalCount'>> } };

type ProjectsIndexPageQueryVariables = Exact<{ [key: string]: never; }>;


type ProjectsIndexPageQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, readonly allProjects: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<MarkdownRemark, 'excerpt'>
        & { readonly frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'github' | 'slug' | 'bannerImageName'>> }
      ) }> }, readonly allProjectImages: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<File, 'base' | 'relativeDirectory'>
        & { readonly childImageSharp: Maybe<{ readonly fluid: Maybe<Pick<ImageSharpFluid, 'aspectRatio' | 'base64' | 'src' | 'srcSet' | 'srcWebp' | 'srcSetWebp' | 'sizes'>> }> }
      ) }> } };
